		...
		<div id="content">
			...
			<div class="post" id="post-<?php the_ID(); ?>">
				<div class="post-title">
					...
					<div class="post-title-info">Author: <?php the_author() ?> &nbsp;|&nbsp; Category: <?php the_category(', ') ?> &nbsp;|&nbsp; <?php comments_popup_link('Comments (0)', 'Comment (1)', 'Comments (%)'); ?> &nbsp;|&nbsp; <a href="<?php the_permalink() ?>#respond">Add Comment</a></div>
				</div>
